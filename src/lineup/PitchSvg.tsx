...
const PitchSvg: React.FunctionComponent<Props> = (props: Props) => {
    ...
    return (
        <svg id="svg_pitch" width="1000" height="585" viewBox="0 0 1000 585">
			...
			M422.5 392.47650000000004 A 135.2 135.2, 0, 0, 1, 577.5 392.47650000000004" fill="none" stroke="#ffffff"
                ...
                <polygon points="379.5 65.8125, 620.5 65.8125, 630.9000000000001 105.2415, 369.09999999999997 105.2415"
                         fill="none" stroke="#ffffff" stroke-linecap="square" stroke-width="2">
                </polygon>
                ...
                <polygon
                    ...
                    fill="#ffffff" fill-opacity=".35" stroke="#ffffff" stroke-linecap="square"
                    stroke-width="2">
                </polygon>
                <polygon
                ...
                <polygon points="555.7 529.4835, 555.7 498.4785, 553.3 484.08750000000003, 553.3 518.0175"
                         fill="#ffffff"
                         fill-opacity=".35" stroke="#ffffff" stroke-linecap="square" stroke-width="2">
                </polygon>
                ...
                <polyline points="446.7 518.0175, 446.7 484.08750000000003, 553.3 484.08750000000003, 553.3 518.0175"
                          fill="none" stroke="#ffffff" stroke-linecap="square" stroke-width="4">
                </polyline>

                {
                    players.map((player) => {
                        let position: string = `translate(${player.coordinates.xposition} ${player.coordinates.yposition})`;
                        let message: string = `Clicked on ${player.name}`;
